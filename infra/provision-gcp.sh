...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --set-secrets="DRUPAL_DB_PASSWORD=${SERVICE_NAME}-database-password:latest,DRUPAL_HASH_SALT=${SERVICE_NAME}-hash-salt:latest,DRUPAL_CRON_KEY=${SERVICE_NAME}-cron-key:latest" \
