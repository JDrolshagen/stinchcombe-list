(function ($, Drupal, drupalSettings, once) {
  Drupal.behaviors.mtSliderRevolutionInternalBanner = {
    attach: function (context, settings) {
      ...
      $(context).find('.region--light-typography .transparent-background').css("backgroundColor", "rgba(0,0,0," + drupalSettings.flashyplus.slideshowBackgroundOpacity + ")");
      $(context).find('.region--light-typography .tp-caption--transparent-background .tp-caption__title').css("backgroundColor", "rgba(0,0,0," + drupalSettings.flashyplus.slideshowCaptionOpacity + ")");
      $(context).find('.region--light-typography .tp-caption--transparent-background .tp-caption__text').css("backgroundColor", "rgba(0,0,0," + drupalSettings.flashyplus.slideshowCaptionOpacity + ")");

      // Set transparent elements bg color for dark typography setting
      $(context).find('.region--dark-typography .transparent-background').css("backgroundColor", "rgba(255,255,255," + drupalSettings.flashyplus.slideshowBackgroundOpacity + ")");
      $(context).find('.region--dark-typography .tp-caption--transparent-background .tp-caption__title').css("backgroundColor", "rgba(255,255,255," + drupalSettings.flashyplus.slideshowCaptionOpacity + ")");
      $(context).find('.region--dark-typography .tp-caption--transparent-background .tp-caption__text').css("backgroundColor", "rgba(255,255,255," + drupalSettings.flashyplus.slideshowCaptionOpacity + ")");
