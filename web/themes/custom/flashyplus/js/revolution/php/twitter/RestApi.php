...
class RestApi {
  ...
  public function __construct($consumerKey, $consumerSecret, $accessToken = NULL, $accessTokenSecret = NULL) {
    if (!function_exists('curl_init')) {
      throw new RestApiException('You must have the cURL extension enabled to use this library');
    }
  ...
  public function connectAsUser() {
    if (!$this->_accessToken || !$this->_accessTokenSecret) {
      throw new RestApiException('Missing ACCESS_TOKEN OR ACCESS_TOKEN_SECRET');
    }
